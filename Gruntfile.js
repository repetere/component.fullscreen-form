...
module.exports = function (grunt) {
	grunt.initConfig({
		simplemocha: {
			options: {
				globals: ['should', 'window', 'document'],
				timeout: 3000,
				ignoreLeaks: false,
				ui: 'bdd',
				reporter: 'spec'
		...
		jsbeautifier: {
			files: ['<%= jshint.all %>', '!resources/template/component_fullscreen_form.ejs'],
			options: {
				config: '.jsbeautify'
			}
		},
		...
		less: {
			development: {
				...
				files: {
					'example/stylesheets/component.fullscreen-form.css': 'resources/stylesheets/component.fullscreen-form.less'
				}
			}
		},
		template: {
